...
public class SearchFlightInfoUI extends JInternalFrame {
	...
	private void initialize() {
		...
		btnSubmit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				sfi.searchFlights(departureDateField.getText(), departureTimeField.getText(),
						departureLocationField.getText(), arrivalDateField.getText(), arrivalTimeField.getText(),
						arrivalLocationField.getText(), numOfPassengersField.getText(), oneWayField.getText(),
				...
				if (departureDateField.getText().equals("")) {
					...
					JOptionPane.showMessageDialog(frmSearchflightinformation,
							"Flight Search Results Successfully Inputted");
				}
