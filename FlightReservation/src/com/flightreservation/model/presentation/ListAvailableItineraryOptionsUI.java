...
public class ListAvailableItineraryOptionsUI extends JFrame{
		...
		btnSubmit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(costField.getText().equals("")) {
						...
						JOptionPane.showMessageDialog(frmListavailableitineraryoptions, "List of Available Itineraries Results Successfully returned");
					}
